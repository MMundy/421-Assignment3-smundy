    ...
    public class MovieActorsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var movieActor = await _context.MovieActor
                .Include(m => m.Actor)
                //.Include(m => m.Actor.Photo)
                .Include(m => m.Movie)
                //.Include(m => m.Movie.Poster)
        ...
        public async Task<IActionResult> Create([Bind("MovieID,Id,ActorID")] MovieActor movieActor)
        {
        ...
        [HttpPost]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MovieID,Id,ActorID")] MovieActor movieActor)
        {
            if (id != movieActor.Id)
            {
                return NotFound();
